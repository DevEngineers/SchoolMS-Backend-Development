...
// Read HTML Template
const html = fs.readFileSync("./reportModule/reportHtmlPages/ResultReportTemplate.html", "utf8");
...
module.exports = async function generateResultReport(fileLocation,results) {
